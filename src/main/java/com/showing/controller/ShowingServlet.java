	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("update".equals(action)) { // 來自update_showing_input.jsp的請求
			...
			String requestURL = req.getParameter("requestURL"); // 送出修改的來源網頁路徑: 可能為【/showing/listAllShowing.jsp】 或  【/movie/listEmps_ByDeptno.jsp】 或 【 /movie/listAllDept.jsp】
				...
				/***************************2.開始修改資料*****************************************/
				ShowingService showingSvc = new ShowingService();
				showingVO = showingSvc.updateShowing(SH_ID, MV_ID, HL_ID, SH_STATE, SH_SEAT_STATE,SH_TIME, SH_TYPE);
				
				/***************************3.修改完成,準備轉交(Send the Success view)*************/				
				MovieService movieSvc = new MovieService();
				if(requestURL.equals("/back_end/movie/listShowings_ByMV_ID.jsp") || requestURL.equals("/back_end/movie/listAllMovie.jsp"))
					req.setAttribute("listShowings_ByMV_ID",movieSvc.getShowingsByMV_ID(MV_ID)); // 資料庫取出的list物件,存入request
        ...
        if ("insert".equals(action)) { // 來自addShowing.jsp的請求  
			...
			req.setAttribute("errorMsgs", errorMsgs);
				...
				/***************************2.開始新增資料***************************************/
				ShowingService showingSvc = new ShowingService();
				showingVO = showingSvc.addShowing(MV_ID, HL_ID, SH_STATE, SH_SEAT_STATE, SH_TIME, SH_TYPE);
		...
		if ("delete".equals(action)) { // 來自listAllShowing.jsp 或  /movie/listEmps_ByDeptno.jsp的請求
			...
			String requestURL = req.getParameter("requestURL"); // 送出刪除的來源網頁路徑: 可能為【/showing/listAllShowing.jsp】 或  【/movie/listShowings_ByMV_ID.jsp】 或 【 /movie/listAllMovie.jsp】
				...
				MovieService movieSvc = new MovieService();
				if(requestURL.equals("/back_end/movie/listShowings_ByMV_ID.jsp") || requestURL.equals("/back_end/movie/listAllMovie.jsp"))
					req.setAttribute("listShowings_ByMV_ID",movieSvc.getShowingsByMV_ID(showingVO.getMV_ID())); // 資料庫取出的list物件,存入request
