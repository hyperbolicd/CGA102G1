package com.fd_ord_dt.controller;
...
import com.fd_ord_dt.model.*;

public class FdOrdDtServlet  extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("getOne_For_Display".equals(action)) { // 來自select_page.jsp的請求
			...
			req.setAttribute("errorMsgs", errorMsgs);
				...
				/***************************1.接收請求參數 - 輸入格式的錯誤處理**********************/
				String str = req.getParameter("fdDtID");
				if (str == null || (str.trim()).length() == 0) {
					errorMsgs.put("fdDtID","請輸入餐飲明細編號");
				}
