...
<jsp:useBean id="listShowings_ByCompositeQuery" scope="request"
	type="java.util.List<ShowingVO>" />
	...
	<main>
		<div id="main">
			...
			<table id="myTable" class="tablesorter">
				...
				<tbody>
					<c:forEach var="showingVO" items="${listShowings_ByCompositeQuery}"
						begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
						<tr align='center' valign='middle'
							${(showingVO.SH_ID==param.SH_ID) ? 'bgcolor=#CCCCFF':''}>
							<!--將修改的那一筆加入對比色而已-->
