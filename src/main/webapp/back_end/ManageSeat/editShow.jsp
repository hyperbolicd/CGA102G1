...
<body>
			...
			<div class="container1">
				<div class="createform">
					<div class="selectShow">
						...
						</select> <select class="form-control" id="showPick">
							<option value="">請先選擇場次日期</option>
						</select>
					</div>
					<form class="form1" id="formId">
						<div class="form-group" style="margin-top: 5px">
							...
							<input type="hidden" id="showSeatSource" value=""> <input
								type="hidden" id="hlRow" value="${hallVO.hlRow}"> <input
								type="hidden" id="hlCol" value="${hallVO.hlCol}"> <input
								type="hidden" id="hlId" value="${hallVO.hlId}">
						</div>
						<div class="btnbox">
	...
	<script
		src="${pageContext.request.contextPath}/back_end/ManageSeat/editShow.js"></script>
	<script
		src="${pageContext.request.contextPath}/back_end/ManageSeat/socketScript.js"></script>
</body>
