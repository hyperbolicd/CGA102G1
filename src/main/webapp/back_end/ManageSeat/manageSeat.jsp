		...
		<div id="main">
			<div class="container1">
				<div class="" style="margin-bottom: 10px">
					<a
						href="${pageContext.request.contextPath}/back_end/ManageHall/manageHall.jsp"
						class="btn btn-info">影廳資訊管理</a>
				</div>
						...
						<c:forEach var="HallVO" items="${list}">
							<tr>
								...
								<td>
									...
									<form METHOD="post"
										action="${pageContext.request.contextPath}/ShowSeatServlet.do">
										<input type="submit" value="場次座位" class="btn btn-success"
											style="margin-top: 5px"> <input type="hidden"
											name="hlId" value="${HallVO.hlId}"> <input
											type="hidden" name="action" value="getDate">
									</form>
								</td>
							</tr>
						</c:forEach>
