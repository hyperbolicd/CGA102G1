				...
				<div class="TKouter">
					<table class="TKinner">
						<tr>
							<th></th>
							<th><a class="tablebt"
								href="${pageContext.request.contextPath}/merchOrd/merchOrd.do?action=getAll_For_Display">全部訂單</a>
							</th>
							<th><a class="tablebt"
								href="${pageContext.request.contextPath}/back_end/merchandiseOrd/orderinsert.jsp">新增訂單</a>
							</th>
						</tr>
						<tr>
							<form
						...
						<tr>
							<form
								...
								<td>顯示訂單編號詳情:</td>
								<td><input type="number" name="merchOrdID"
									placeholder="請輸入訂單編號" min=1 required></td>
								<td><button class="tablebt" type="submit" name="action"
