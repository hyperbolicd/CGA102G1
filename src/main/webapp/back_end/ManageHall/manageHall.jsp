		...
		<div id="main">
			...
			<div class="table_body">
				<div class="btnbox" style="margin-bottom: 10px">
					<a
						href="${pageContext.request.contextPath}/back_end/ManageHall/createHall.jsp"
						class="btn btn-outline-success">新建影廳</a> <a
						href="${pageContext.request.contextPath}/back_end/ManageSeat/manageSeat.jsp"
						class="btn btn-outline-info">座位管理</a>
				</div>
				<div class="table_container">
					<table class="table table-hover table-bordered single-ellipsis"">
						...
						<tbody>
							...
							<c:forEach var="HallVO" items="${list}" begin="<%=pageIndex%>"
