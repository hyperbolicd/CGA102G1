...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/back_end/wish/css/wishPond.css">
</head>
...
<body>
	...
	<main>
		<div id="main">
			...
			<button id="newWish">
				<a
					href="${pageContext.request.contextPath}/back_end/wish/newWish.jsp">新增</a>
			</button>
			...
			<div id="multiSearch">
				...
				<!--                     <br> -->
				<form
					action="${pageContext.request.contextPath}/wish/WishingPond.do"
					method="post">
					<label for="searchPeriod">時間: </label> <select name="searchPeriod"
						id="searchPeriod">
						<option value="WISH_START">以起始時間搜尋</option>
						<option value="WISH_END">以結束時間搜尋</option>
					</select> <input name="start_date" id="start_date" autocomplete="off">
					~ <input name="end_date" id="end_date" autocomplete="off">
					<label for="searchName">名稱: </label> <input name="searchName"
						id="searchName">
