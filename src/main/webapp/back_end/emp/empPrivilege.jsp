...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/back_end/emp/css/empPrivilege.css">
</head>
...
<body>
	...
	<main>
		<div id="main">
			<form method="post"
				action="${pageContext.request.contextPath}/emp/EmpPrivilege.do">
				...
				<div id="auth">
					...
					<label for="funcs0" class="big">一般職員權限</label> <input
						...
						for="funcs1" class="big">管理員權限</label>
					...
					<div class="fc_block">
						<c:forEach var="function" items="${listF.all}" begin="0" step="3">
							<input type="checkbox" name="fc_nos" value="${function.fc_no}"
								...
								<c:forEach var="empPriVO" items="${empPriVOs}"><c:if test="${function.fc_no == empPriVO.fc_no}">checked</c:if></c:forEach>>
	...
	<script
		src="${pageContext.request.contextPath}/back_end/emp/js/empPrivilege.js"></script>
</body>
