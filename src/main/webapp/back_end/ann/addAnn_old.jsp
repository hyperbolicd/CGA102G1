				...
				<FORM METHOD="post" enctype="multipart/form-data"
					...
					<div class="TKouter">
						...
						<table class="TKinner">
							...
							<tr>
								<td>圖片:</td>
<!-- 								<td><input class="up" type="file" name="ann_picture"size="45" accept="image/*">  -->
<%--    							    <img class="add_ann_img" name="ann_no" src="${pageContext.request.contextPath}/AnnBlob_Reader?ann_no=${annVO.ann_no}"></td> --%>
...
//    const img = document.getElementsByClassName("add_ann_img")[0];
