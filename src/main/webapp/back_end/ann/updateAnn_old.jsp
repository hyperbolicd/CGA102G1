				...
				<FORM METHOD="post" name="form1" enctype="multipart/form-data"
					...
					<div class="TKouter">
						...
						<table class="TKinner">
							...
							<tr>
								<td>圖片:</td>
<%-- 							<td><input class="up" type="file" name="ann_picture" size="45" accept="image/*" value="<%=annVO.getAnn_picture()%>/AnnBlob_Reader"/> --%>
<%-- 							<img class="ann_img" name="ann_no" src="${pageContext.request.contextPath}/AnnBlob_Reader?ann_no=${annVO.ann_no}"></td>							 --%>
...
//    const img = document.getElementsByClassName("ann_img")[0];
