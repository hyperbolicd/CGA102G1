...
<body>
			...
			<div class="form1" style="width: 100%">
				<form method="post"
					...
					<div class="mvName">
						...
						<input class="form-control" id="mvName" type="text" name="MV_NAME"
							placeholder="請填入中文名稱"> <label
							class="col-sm-2 col-form-label" for="mvEname">電影英文名稱:</label> <input
							class="form-control" id="mvEName" type="text" name="MV_E_NAME"
							placeholder="請填入英文名稱">
					</div>
					<hr>
					<div class="mvLevel">
						<label class="col-sm-2 col-form-label">電影分級:</label> <select
							class="custom-select" id="mvLevel" name="MV_LEVEL">
							...
							class="custom-select" id="mvType" name="MV_TYPE">
					...
					<div class="editBox">
						<input type="hidden" name="action"
							value="listMovie_ByCompositeQuery">
						<button type="submit" id="sumbitBtn"
							class="btn btn-primary btn-lg">搜尋</button>
						<button type="button" onclick="history.back()"
							class="btn btn-danger btn-lg">取消</button>
					</div>
				</form>
			</div>
		</div>
	...
	<script
		src="${pageContext.request.contextPath}/back_end//ManageMV/query_regex.js"></script>
</body>
