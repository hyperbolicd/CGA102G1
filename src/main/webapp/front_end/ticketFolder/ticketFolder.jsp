...
<meta charset="UTF-8">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/front_end/ticketFolder/ticketFolder.css">
			...
			<div class="container">
				<c:forEach items="${OrdVOList}" var="OrdVO" varStatus="loop">
					<div class="content">
						<div class="cover">
							<img
								src="${pageContext.request.contextPath}${mvList[loop.index].mvPicture}"
								alt="">
						</div>
						<div class="info_container">
							<div class="info">
								...
								<div class="shDate">
									場次:
									<fmt:formatDate pattern="yyyy-MM-dd H點m分"
										value="${showList[loop.index].SH_TIME}" />
								</div>
						...
						<div class="bt">
							<form
								action="${pageContext.request.contextPath}/TkFolderServlet.do"
								method="post">
								<input type="hidden" name="tkOrdID"
									value="${OrdVOList[loop.index].tkOrdID}"> <input
