...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/front_end/memberCmt/css/memberCmt.css" />
<link rel="stylesheet"
	...
	<main>
		<div id="mainDiv">
			...
			<div id="cartMain">
				...
				<FORM METHOD="post"
					ACTION="<%=request.getContextPath()%>/cmt/cmt.do" id="form1">
					<input type="hidden" name="requestURL"
						value="<%=request.getServletPath()%>"> <input
						type="hidden" name="action" value="selectedDelete">
				</FORM>
				<div id="cartBody">
					...
					<c:forEach var="cmtVO" items="${list}">
						<c:if test="${cmtVO.CM_STATE != 2}">
							<div class="eachItem">
								<div class="check">
									<input type="checkbox" name="cmtID" class="checkOne"
										value="${cmtVO.CM_ID}" form="form1" />
								</div>
								<div class="vl"></div>
								...
								<div class="edit">
									...
									<FORM METHOD="post"
										...
										<input type="submit" value="刪除"> <input type="hidden"
											name="CM_ID" value="${cmtVO.CM_ID}"> <input
