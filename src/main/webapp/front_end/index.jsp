...
<body>
  ...
  <div class="wrapper row1" style="height:60px;">
    ...
    <div id="banner">    
        <!-- 輪播圖片 -->
        <div id="tab">
            <img class="tabImg" src="images/movie3.jpg" height="400" width="100%"/>
            <img class="tabImg" src="images/movie4.jpg" height="400" width="100%"/>
            <img class="tabImg" src="images/movie5.jpg" height="400" width="100%"/>
            <img class="tabImg" src="images/movie6.jpg" height="400" width="100%"/>
        </div>
        <!-- 指示符 -->
        <div class="lunbo_btn">
